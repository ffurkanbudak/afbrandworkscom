...
const Beam = ({
  ...
  // Site kimliğine uyum: huzmeler gökkuşağı yerine kırmızı tonlarında (#DC2626 ~ hue 0)
  const hue = (Math.floor(Math.random() * 20) - 10 + 360) % 360;
      ...
      style={
        {
          ...
          '--width': `${width}`,
          '--aspect-ratio': `${ar}`,
          '--background': `linear-gradient(hsl(${hue} 72% 51%), transparent)`,
